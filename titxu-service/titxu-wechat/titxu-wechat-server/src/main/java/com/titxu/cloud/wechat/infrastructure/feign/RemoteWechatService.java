package com.titxu.cloud.wechat.infrastructure.feign;


import com.titxu.cloud.common.core.util.ResponseModel;
import com.titxu.cloud.wechat.infrastructure.feign.contract.request.*;
import com.titxu.cloud.wechat.infrastructure.feign.factory.RemoteWechatServiceFallbackFactory;
...
@FeignClient(name = "wechat", url = "${wechat.config.url}", fallbackFactory = RemoteWechatServiceFallbackFactory.class)
